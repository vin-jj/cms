...
import {
  ...
  WHITE_PAPER_UNLOCK_COOKIE_MAX_AGE,
...
const leadsPath = path.join(leadsDir, "white-paper-download-leads.json");
...
export async function POST(request: Request) {
  ...
  response.cookies.set({
    httpOnly: false,
    maxAge: WHITE_PAPER_UNLOCK_COOKIE_MAX_AGE,
    name: WHITE_PAPER_UNLOCK_COOKIE,
    path: "/",
    sameSite: "lax",
    value: "true",
  });
