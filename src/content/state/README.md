...
<<<<<<< HEAD
- 초기값은 `src/content/managed/content-seed.json`, `src/content/demo/content-seed.json`, `src/content/documentation/content-seed.json`, `src/content/news/content-seed.json`, news seed를 합쳐 생성합니다.
=======
