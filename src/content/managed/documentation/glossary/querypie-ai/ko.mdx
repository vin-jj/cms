...
layout: "Article"
category: "glossary"
title: "QueryPie Glossary - 주요 용어 및 정의"
description: "QueryPie의 데이터 거버넌스 및 보안과 관련된 주요 용어를 살펴보세요. 우리 플랫폼과 보안 업계를 이해하는 데 중요한 용어들을 한눈에 확인할 수 있습니다."
<<<<<<< HEAD
ogImage: "public/documentation/glossary/docu-thumb-glossary.webp"
keywords: ["QueryPie", "쿼리파이", "용어집", "데이터 거버넌스", "보안", "주요 용어"]
relatedPosts:
  - image:
...
>>>>>>> origin/main
        alt: "최신 릴리스 노트"
    href: "https://docs.querypie.com/ko/release-notes"
    external: true
    label: "최신 릴리스 노트"
  - image:
<<<<<<< HEAD
...
>>>>>>> origin/main
        alt: "관리자 매뉴얼"
    href: "https://docs.querypie.com/ko/administrator-manual"
    external: true
    label: "관리자 매뉴얼"
  - image:
<<<<<<< HEAD
...
>>>>>>> origin/main
        alt: "사용자 매뉴얼"
    href: "https://docs.querypie.com/ko/user-manual"
    external: true
    label: "사용자 매뉴얼"
---
...
# A
---
## ABAC <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## ACL <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## APPI <State color="blue">DAC</State>
...
# C
---
## CCPA <State color="blue">DAC</State>
...
## CIEM <State color="green">SAC</State>
...
## CSPM <State color="green">SAC</State>
...
## DML <State color="blue">DAC</State>
...
## Docker  <State color="purple">KAC</State>
...
# E
---
## EDR <State color="green">SAC</State> <State color="purple">KAC</State>
...
# F
---
## FedRAMP <State color="green">SAC</State> <State color="purple">KAC</State>
...
# G
---
## GDPR <State color="blue">DAC</State>
...
# H
---
## HIPPA <State color="blue">DAC</State>
...
# I
---
## IaC <State color="green">SAC</State> <State color="purple">KAC</State>
...
## IAM <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## IdP <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## ISMAP <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## ISMS-P <State color="blue">DAC</State>
...
## ISO27701 <State color="blue">DAC</State>
...
# J
---
## J-SOX <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
# K
---
## K-SOX <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## Kubernetes (k8s) <State color="purple">KAC</State>
...
# M
---
## MDM <State color="green">SAC</State>
...
# P
---
## PAM <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## PCI DSS <State color="blue">DAC</State>
...
## PHI <State color="blue">DAC</State>
...
## PII <State color="blue">DAC</State>
...
# R
---
## RBAC <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
# S
---
## SOC <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## SOC 1 <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## SOC 2 <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## SOC 3 <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
...
## SSH <State color="green">SAC</State>
SSH(Secure Shell)은 네트워크를 통해 컴퓨터나 서버에 안전하게 접근하기 위한 프로토콜입니다. 주로 원격 로그인이나 명령 실행에 사용되며, 통신 내용을 암호화하여 데이터 도청과 변조로부터 보호합니다.

# Z
---
## ZTNA <State color="blue">DAC</State> <State color="green">SAC</State> <State color="purple">KAC</State>
